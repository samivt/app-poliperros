...
const EditAdoptedDog = ({ onSave }) => {
  ...
  useEffect(() => {
    const loadDog = async () => {
      try {
        const dogData = await fetchAdoptedDogById(id);
        setFormData({
          id_chip: dogData.id_chip,
          name: dogData.name,
          adopted_date: dogData.adopted_date,
          age: dogData.age,
  ...
  return (
    <div className="custom-form-container">
      <h2 className="form-title">Editar Perro Adoptado</h2>
      ...
      <Form onSubmit={handleSubmit}>
        ...
        {/* Nombre */}
        <Form.Group className="mb-4">
          <Form.Label className="custom-label">Nombre2:</Form.Label>
          <Form.Control
            type="text"
            name="name"
            value={formData.name}
        ...
        {/* Fecha de adopcion */}
        <Form.Group className="mb-4">
          <Form.Label className="custom-label">Fecha de adopcion:</Form.Label>
          <Form.Control
            type="date"
            name="adopted_date"
        ...
        <div className="custom-button-container">
          ...
          <Button
            ...
            onClick={() => navigate("/admin/adopted-dogs")}
          >
            Cancelar
          </Button>
        </div>
